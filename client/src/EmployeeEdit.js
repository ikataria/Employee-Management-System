...
function EmployeeEdit() {
    ...
    function updateEmpDetails(e) {
        ...
        if ((form.employeeType.value == 'Contract' || form.employeeType.value == 'Seasonal') && (form.title.value == 'Manager' || form.title.value == 'Director' || form.title.value == 'VP')){
            ...
            setErrMsgTitle("Contractor/Seasonal Employee Can't be Manager/Director/VP.");
        ...
        `;
            ...
            fetch('http://localhost:7000/graphql', {
                ...
                body: JSON.stringify({ query, variables: { 
                    ...
                    Age: employee.age, 
                    CurrentStatus: document.getElementById("statusChk").checked ? 1 : 0 
                    } 
                })
            }).then(async (response) => {
                await response.json();
            ...
            <form name="addEmployeeForm" onSubmit={updateEmpDetails}>
                ...
                <div class="row">
                    ...
                    <div className="col-75">
                        ...
                        <span style={{ color: "red" }}>{errMsgTitle}</span>
                    </div>
                </div>
